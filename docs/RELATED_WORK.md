...
This note situates **Training Deception Probes on On-Policy Lies** against the motivating literature for
[Training Deception Probes on On-Policy Lies](https://github.com/alanasung/onpolicy-deception-probes).

## Positioning

Train and evaluate deception probes on on-policy model-generated lies rather than off-policy text.

The design hypothesis is: Train and evaluate deception probes on on-policy model-generated lies rather than off-policy text.
