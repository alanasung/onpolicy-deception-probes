...
def _registered_builder(name: str):
    ...
    try:
        module = importlib.import_module("lieprobe.data")
...
def main(argv: list[str] | None = None) -> int:
    ...
    from lieprobe.utils.run_manifest import utc_now_iso, write_json_atomic
    ...
    if builder is not None:
        ...
        source = f"lieprobe.data.BUILDERS[{data.name!r}]"
        ...
        print(
            ...
            "src/lieprobe/data/__init__.py under BUILDERS, or use data=synthetic "
