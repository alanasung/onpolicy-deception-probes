"""Experiment stages for Training Deception Probes on On-Policy Lies."""
...
from .lieprobe._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(
        out / "report.json",
        {"headline": "Training Deception Probes on On-Policy Lies", "claims_gated": True},
    )
